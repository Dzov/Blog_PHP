...
class Twig_Tests_Loader_FilesystemTest extends \PHPUnit\Framework\TestCase
{
    public function testGetSourceContext()
    {
        ...
        $this->assertEquals('errors/base.twig', $loader->getSourceContext('errors/base.twig')->getName());
        $this->assertEquals(realpath($path.'/errors/base.twig'), realpath($loader->getSourceContext('errors/base.twig')->getPath()));
    }
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('base.twig')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/base.twig')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/base.twig')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for base.twig in the named namespace
        $namedSource = $loader->getSourceContext('@named/base.twig')->getCode();
        $this->assertEquals("named path\n", $namedSource);

        // get base.twig from the main namespace
